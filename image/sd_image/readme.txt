...
sudo ./make_sdimage_bm.sh -k uImage,socfpga.dtb -p preloader.bin -b u-boot.img -a bm.bin -f bm.rbf -r /home/xuewt/share/yocto/build/tmp/work/socfpga_cyclone5-poky-linux-gnueabi/altera-image-1.0-r0/rootfs/ -o sd_image_bm.bin
...
Kingston class 4 4GB:
  boot time: 46-46ms   load bm time: 23ms
  
Sony     class 10 16GB:
  boot time: 44ms      load bm time: 20ms
