...
#ifdef CONFIG_USE_OSC1_TIMER1
/* Assert reset to all peripherals through reset manager */
void reset_assert_all_peripherals_except_l4wd0_osc1timer1(void)
{
	writel(~((1<<RSTMGR_PERMODRST_L4WD0_LSB) | (1 << RSTMGR_PERMODRST_OSC1TIMER1_LSB)),
