...
void spl_board_init(void)
{
	 ...
	 */
#if !defined(CONFIG_USE_OSC1_TIMER1)
...
*                        www.embest-tech.com
***************************************************************************
* The L4 OSC1 Timer1 is used for testing BM load time, and it must be released reset
* here, otherwise the time1 can't work well for late time.
*/
	reset_assert_all_peripherals_except_l4wd0_osc1timer1();
#endif
