...
extern void boot_bm_on_cpu1(void);
extern int cpu0_wait_cpu1_load_rbf(void);
extern void amp_share_param_init(void);
extern void load_bm_start(void);
extern void load_bm_end(void);
...
* 
*/
		amp_share_param_init();

		load_bm_start();
		
		spl_mmc_probe();

		spl_mmc_load_bm_image_mbr();
...
***************************************************************************
*
* It will load bm.bin first when boot from the qspi flash.
* and after spl_board_init, the ddr is ok now.
*/
