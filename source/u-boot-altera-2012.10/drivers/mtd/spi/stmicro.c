...
***************************************************************************
*
*  remove the static domain.
*
*/
int stmicro_set_4byte(struct spi_flash *flash, u8 enable)
{
	u8 cmd;
	int ret;
...
***************************************************************************
*
*  remove the 4-bytes address mode in default
*  the bootrom will use 3-bytes address to access the qspi in default,
*  it is a known bug for it.
*  and if we set 4-bytes addresss mode here, it won't reset
*  the board in the qspi boot mode.
*  and if you reset the board when you are reading or writing
*  the qspi flash, it won't restart board at this circumstance.
*/
#if 0
